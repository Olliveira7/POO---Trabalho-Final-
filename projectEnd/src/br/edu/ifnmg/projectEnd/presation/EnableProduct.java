 ...
 * @author Diego
 */
public class EnableProduct extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Enable Product");
    ...
    private void btnSearcheActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearcheActionPerformed
        if(!txtName.getText().isEmpty() && !txtId.getText().isEmpty()){
            if(this.repository.CheckProduct(txtName.getText()) == false){
                if(this.repository.CheckStatus(Integer.parseInt(txtId.getText())) == false){
                    this.product = this.repository.Open(Integer.parseInt(txtId.getText()));
                    setProduct();
                }else{
                    JOptionPane.showMessageDialog(null, "Account Enable!");
                    setNull();
                }
            }else{
    ...
    private void btnEnableActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnableActionPerformed
        if(!txtName.getText().isEmpty() && !txtName.getText().isEmpty()){
            if(this.repository.CheckProduct(txtName.getText()) == false){
                if(this.repository.CheckStatus(Integer.parseInt(txtId.getText())) == false){
                    String consult = "update product set status = 1 where id =";
