 ...
 * @author Diego
 */
public class AuthenticateUserSale extends javax.swing.JInternalFrame {

    /**
     * Creates new form AuthenticateUserSale
     */
    public AuthenticateUserSale() {
        initComponents();
    }
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if(!this.txtUser.getText().isEmpty() && this.txtPassword.getPassword().length > 0){
            ...
            if(user == null){
                ...
                if(user.getStatus() == 1){
                    SaleProduct screen = new SaleProduct(user);
